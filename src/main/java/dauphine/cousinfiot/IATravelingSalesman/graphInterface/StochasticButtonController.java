...
public class StochasticButtonController implements ActionListener {
	private CityMap cities;
	private Graphics g;
	private Container container;

	public StochasticButtonController(JButton button, CityMap cities, Graphics g, Container container) {
