...
public class HillButtonController implements ActionListener {
	private CityMap cities;
	private Graphics g;
	private Container container;

	public HillButtonController(JButton button, CityMap cities, Graphics g, Container container) {
	...
	public void actionPerformed(ActionEvent e) {
		container.update(g);
		HillClimbingAlgorithm hill = new HillClimbingAlgorithm();
